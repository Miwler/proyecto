...
<?php
    ...
    <span class="glyphicon glyphicon-align-left"></span> Editar Menú
<?php } ?>                
...
<?php function fncPage(){?>
    ...
    <div class="panel panel-success">
        <form id="frm1" name="frm1" method="post" action="/Configuracion_General/Menu_Mantenimiento_Editar/<?php echo $GLOBALS['oMenu']->ID;?>" onsubmit="return validar();">
            ...
            <div class="row">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <select id="selMenu_Padre" name="selMenu_Padre" class="form-control form-requerido text-uppercase">
                        ...
                        <?php foreach($GLOBALS['oMenu']->dtMenu_Padre as $value){?>
            ...
            <div class="row">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="number" id="txtOrden" name="txtOrden" autocomplete="off" class="form-control" value="<?php echo $GLOBALS['oMenu']->orden; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right" >
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtDescripcion" name="txtDescripcion" autocomplete="off" class="form-control" value="<?php echo FormatTextView($GLOBALS['oMenu']->descripcion); ?>" >
                </div>
            </div>
            </center>
    ...
    $(document).ready(function(){
        $("#selModulo").val(<?php echo $GLOBALS['oMenu']->modulo_ID;?>);
        $("#selMenu_Padre").val(<?php echo $GLOBALS['oMenu']->menu_ID;?>);
    });
