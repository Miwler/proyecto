...
<form id="form"  method="POST" action="/Configuracion_General/Persona_Mantenimiento_Editar/<?php echo $GLOBALS['oPersona']->ID;?>" onsubmit="return validar();" class="form-horizontal">
