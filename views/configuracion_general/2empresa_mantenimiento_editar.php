...
<?php
    ...
    <span class="glyphicon glyphicon-briefcase"></span> Editar Empresa
<?php } ?>                
...
<?php function fncPage(){?>
    ...
    <div class="panel panel-success">
        <form id="frm1" method="post" enctype="multipart/form-data" action="/Configuracion_General/Empresa_Mantenimiento_Editar/<?php echo $GLOBALS['oEmpresa']->ID;?>" onsubmit="return validar();">
                    ...
                    <div id="tab1" class="tab-pane fade in active">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                                ...
                                <script>
                                $('#selStilo_fondo_cabecera').val("<?php echo $GLOBALS['oEmpresa']->stilo_fondo_cabecera;?>");
                                </script>
