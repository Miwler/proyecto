...
<?php
    ...
    <span class="glyphicon glyphicon-briefcase"></span> Nuevo Empresa
<?php } ?>                
    ...
    <div class="panel panel-success">
        <form id="frm1" name="frm1" method="post" action="/Configuracion_General/Menu_Mantenimiento_Nuevo" onsubmit="return validar();">
            ...
            <div class="row">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtImagen" name="txtImagen" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtRuta" name="txtRuta" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtIcono" name="txtIcono" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtLogo" name="txtLogo" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtStilo_fondo_tabs" name="txtStilo_fondo_tabs" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtStilo_fondo_boton" name="txtStilo_fondo_boton" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 text-right">
                ...
                <div class="col-xs-9 col-md-9 col-sm-9 col-lg-9">
                    <input type="text" id="txtStilo_fondo_cabecera" name="txtStilo_fondo_cabecera" autocomplete="off" value="<?php echo $GLOBALS['oMenu']->url;?>" class="form-control form-requerido">
                </div>
            </div>
            </center>
