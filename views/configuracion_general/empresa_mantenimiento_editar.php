...
<?php function fncPage(){?>
    ...
    <form id="frm1"  method="post" enctype="multipart/form-data" action="/Configuracion_General/Empresa_Mantenimiento_Editar/<?php echo $GLOBALS['oEmpresa']->ID?>" onsubmit="return validar();" class="tab-content form-horizontal form-bordered">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txtClassIcono" name="txtClassIcono" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->icono?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <ul class="list-group" id="divModulos">
                                        <?php $array_modulo=explode(',',$GLOBALS['oEmpresa']->lista_modulo);?>
                                        <?php foreach($GLOBALS['dtModulo'] as $modulo){?>
                                        <li class="list-group-item">
                                            
                                            <div class="ckbox ckbox-teal">
                                                <input id="<?php echo $modulo['ID']?>" type="checkbox" <?php echo ((array_search($modulo['ID'],$array_modulo)>=0)?"checked":"");?>>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <script>
                                        $("#SelMoneda").val(<?php echo $GLOBALS['oEmpresa']->moneda;?>);
                                    </script>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" id="txtPeriodo" name="txtPeriodo" autocomplete="off" min="1000" class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->periodo_inicio;?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <script>
                                        $("#SelEstadoCompra").val(<?php echo $GLOBALS['oEmpresa']->estado_compra;?>);
                                    </script>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <script>
                                        $("#SelComprobanteCompra").val(<?php echo $GLOBALS['oEmpresa']->compra_tipo_comprobante_ID;?>);
                                    </script>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtLink_Comprobante_Electronico" name="txtLink_Comprobante_Electronico" autocomplete="off" class="form-control" autocomplete="off" value="<?Php echo $GLOBALS['oEmpresa']->link_comprobante_electronico;?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <script>
                                        $("#selDepartamento1").val(<?php echo $GLOBALS['oEmpresa']->departamento_ID_default;?>);
                                    </script>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtOpcionesCorreo" name="txtOpcionesCorreo" autocomplete="off"  class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->configuracion_correo_empresa;?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtWebServisGuiaBeta" name="txtWebServisGuiaBeta" autocomplete="off" class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->beta_ws_guia;?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtWebServisFacturaBeta" name="txtWebServisFacturaBeta" autocomplete="off"  class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->beta_ws_factura;?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtWebServisGuiaProd" name="txtWebServisGuiaProd" autocomplete="off"  class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->produccion_ws_guia;?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="txtWebServisFacturaProd" name="txtWebServisFacturaProd" autocomplete="off" class="form-control" autocomplete="off" value="<?php echo $GLOBALS['oEmpresa']->produccion_ws_factura;?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="SelWebServis" name="SelWebServis" class="form-control">
                                     ...
                                     <script>
                                        $("#SelWebServis").val("<?php echo $GLOBALS['oEmpresa']->conexion_ws_sunat;?>");
                                    </script>
