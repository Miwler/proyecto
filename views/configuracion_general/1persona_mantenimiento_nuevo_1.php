...
<form id="form"  method="POST" action="/Configuracion_General/Persona_Mantenimiento_Nuevo" style="width:700px;padding-top:15px;margin:0 auto;" onsubmit="return validar();" >
