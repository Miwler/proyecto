...
function fncTitleHead() { ?>Nueva Persona<?php } ?>
...
<form id="form1" method="POST" action="/Configuracion_General/Persona_Mantenimiento_Nuevo" style="width:920px; height: 550px;" onsubmit="return validar();">
