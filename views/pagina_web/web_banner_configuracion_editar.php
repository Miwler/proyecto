...
<form id="form"  method="POST" class="form-horizontal" action="/Pagina_Web/Web_Banner_Configuracion_Editar/<?php echo $GLOBALS['oWeb_Banner']->ID;?>" onsubmit="return validar();">
    <div class="form-body">
...
<script type="text/javascript">
    var validar=function(){
        ...
        if(nombre==""){
            mensaje.advertencia('MENSAJE DE VERIFICACIÓN',"Tiene que registrar un nombre.",'txtNombre');
