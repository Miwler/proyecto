...
function fncTitle() { ?>Nuevo Menú<?php } ?>
...
function fncTitleHead() { ?>Nuevo menú<?php } ?>
            ...
            <div class="panel-body">
                ...
                <div class="tab-content" style="padding-top:10px;">
                    ...
                    <div id="lista" class="tab-pane fade">
                        ...
                        <div class="row">
                            <div id="divLista" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="height: 300px;overflow:auto;">
