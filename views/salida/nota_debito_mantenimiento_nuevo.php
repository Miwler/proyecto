...
?>	
<?php function fncTitle(){?>Nota de débito<?php } ?>
...
<?php function fncTitleHead(){ ?>Nota de débito<?php } ?>
...
<form id="form" method="POST" action="/Salida/Nota_Debito_Mantenimiento_Nuevo"  class="form-horizontal" >
    ...
    <div class="panel panel-tab rounded shadow">
        ...
        <div class="panel-footer">
            <div class="pull-left">
                <button type="button" class="btn btn-success" onclick="modal.confirmacion('El proceso es irreversible, esta seguro de generar la nota de débito.','Generación de nota de débito',generar);">Guardar</button>
                 <?php if($GLOBALS['ob']->estado_ID==91){?>
                <button type="button" class="btn btn-primary" onclick="modal.confirmacion('El proceso es irreversible, esta seguro de enviar la nota de débito a la SUNAT.','Envío de nota de débito',fncEnviar);">Enviar SUNAT</button>
                <button type="button" class="btn btn-primary" onclick="fncVista_Previa();"><i class="fa fa-file-pdf-o"></i> ver PDF</button>
               
                    <?php } ?>
                
                <button type="button" class="btn btn-danger" onclick="cerrar();">Salir</button>
...
<script type="text/javascript">
    ...
    var fncEnviar=function(){
        ...
        try{
            block_ui(function(){
                cargarValores('Salida/ajaxEnviarNota_DebitoSUNAT',id,function(resultado){
                    if(resultado.resultado==1){
    ...
    var fncVista_Previa=function(){
        var id=$("#txtID").val();
        parent.window_float_open_modal_hijo("VER NOTA DÉBITO","Salida/Comprobante_Regula_Vista_Previa",id,"",null,700,600);
    ...
    var fncBuscarFacturas=function(){
        parent.window_float_open_modal_hijo("FACTURAS EMITIDAS","Salida/factura_venta_emitidas",'',"",cargarInformacion,700,450);
...
<?php if(isset($GLOBALS['resultado'])&&$GLOBALS['resultado']==-1){ ?>
    <script type="text/javascript">
        $(document).ready(function () {
        mensaje.error('<?php echo $GLOBALS['mensaje']; ?>');
        });
    </script>
<?php } ?>
<?php if(isset($GLOBALS['resultado'])&&$GLOBALS['resultado']==1){ ?>
