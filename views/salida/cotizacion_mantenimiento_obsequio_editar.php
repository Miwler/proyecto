...
<form id="frm1"  method="post" action="Salida/Cotizacion_Mantenimiento_Obsequio_Editar/<?php echo $GLOBALS['oCotizacion_Detalle']->ID;?>" onsubmit="return validar();" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="ckbox ckbox-theme">
                                <input id="ckSeparacion"  name="ckSeparacion" <?php echo (($GLOBALS['oCotizacion_Detalle']->separacion==0)?"":"checked");?>  type="checkbox" value="1">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <input type="number" id="txtTiempo_Separacion" name="txtTiempo_Separacion" <?php echo (($GLOBALS['oCotizacion_Detalle']->separacion==0)?"disabled":"");?>  value="1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
