...
<form id="form" method="POST" action="/Salida/Nota_Debito_Mantenimiento_Editar/<?php echo $GLOBALS['ob']->ID;?>"  class="form-horizontal" >
    <input type="hidden" id="llave" name="llave" value="<?php echo $GLOBALS['llave'];?>">
    <input type="hidden" id="txtID" value="<?php echo $GLOBALS['ob']->ID;?>">
    <!-- Start default tabs -->
    <div class="panel panel-tab rounded shadow">
        ...
        <div class="panel-footer">
            <div class="pull-left">
                <?php if($GLOBALS['ob']->estado_ID==90||$GLOBALS['ob']->estado_ID==91){?>
                <button type="button" class="btn btn-success" onclick="modal.confirmacion('El proceso es irreversible, esta seguro de generar la nota de débito.','Generación de nota de débito',generar);">Generar</button>
                <?php } ?>
            ...
            block_ui(function(){
                cargarValores('Salida/ajaxEnviarNota_DebitoSUNAT',id,function(resultado){
                    if(resultado.resultado==1){
                       ...
                       $.unblockUI();
                        mensaje.error("OCURRIÓ UN ERROR",resultado.mensaje,function(){
