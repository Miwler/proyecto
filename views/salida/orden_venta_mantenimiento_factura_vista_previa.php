...
<?php function fncHead(){?>
	...
	<script type="text/javascript" src="include/js/jForm.js"></script>
        ...
        $(document).ready(function(){
          pdf.mostrar('Ventas/Factura_Vista_Previa/<?php echo $GLOBALS['oOrden_Venta']->ID;?>');
        });
        </script>
<?php } ?>
...
<form id="frm1"  method="post"  action="Ventas/Orden_Venta_Mantenimiento_Factura_Vista_Previa/<?php echo $GLOBALS['oOrden_Venta']->ID;?>" onsubmit="return validar();">
    <div class="form-body">
