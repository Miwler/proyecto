...
<form id="frm1" method="post"  action="Salida/Cotizacion_Mantenimiento_Registro_Adicional_Nuevo/<?php echo $GLOBALS['oCotizacion_Detalle']->cotizacion_detalle_padre_ID;?>" onsubmit="return validar();" class="form-horizontal">
