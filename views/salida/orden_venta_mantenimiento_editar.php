...
$(document).ready(function(){
    ...
    <?php if($GLOBALS['oOrden_Venta']->bloquear_edicion>0){?>
            bloquear_edicion_emitido();
    <?php } ?>
            ...
            <div class="tab-content">
                ...
                <div id="divDatos_Generales" class="tab-pane fade inner-all">
                    <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <input id="txtCotizacion_ID" style="display: none">
...
<script type="text/javascript">
   ...
   var fncRegistrar_Productos=function(){
    ...
    $('#btnDescargar').click(function(){
        ...
        if(cotizacion_ID!=''){
             pdf.descargar('Cotizacion/Cotizacion_PDF/'+cotizacion_ID);
        }else {
    ...
    var bloquear_edicion_emitido=function(){
       ...
       //Ocultamos los botones
       //$('#btnEnviar').prop('disabled',true);
       $('#btnEditar').html('<img src="/include/img/boton/edit_48x48.png"> Ver');
       //$('#btnEnviar').css('display', 'none');
