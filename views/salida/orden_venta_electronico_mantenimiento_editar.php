                     ...
                     <div class="row">
                         <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <textarea id="txtDireccion" name="txtDireccion" disabled style="height: 60px;overflow:auto;resize:auto;" class="form-control form-requerido" ><?php echo (trim($GLOBALS['oCliente']->direccion)); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
   ...
   var fncRegistrar_Productos=function(){
    ...
    var fncVerComprobante =function(ID){
        ...
        //window_float_deslizar('form','/Ventas/orden_venta_mantenimiento_producto_nuevo',orden_venta_ID,'',fncCargar_Detalle_Orden_Venta);
        parent.window_float_open_modal_hijo("VER COMPROBANTE DE VENTA","Salida/Orden_Venta_Electronico_Mantenimiento_Comprobante_Editar",ID,"",fncGenerarComprobantes,700,450);
    }
