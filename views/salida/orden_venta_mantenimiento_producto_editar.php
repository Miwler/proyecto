...
<form id="frm1"  method="post"  action="Salida/Orden_Venta_Mantenimiento_Producto_Editar/<?php echo $GLOBALS['oOrden_Venta_Detalle']->ID;?>" onsubmit="return validar();" class="form-horizontal">
    <div class="panel panel-tab rounded shadow">
        ...
        <div class="panel-body rounded-bottom" style="height:450px;overflow:auto; ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                     <input type="text" id="txtPeso" name="txtPeso" class="form-control" value="<?php echo $GLOBALS['oOrden_Venta_Detalle']->peso;?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <script>
                                            <?php if($GLOBALS['oOrden_Venta_Detalle']->tipo_sistema_calculo_isc_ID!="NULL") {?>
                            ...
                            <table id="tbCostos" class="table table-bordered table-hover table-primary">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdSubTotalDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->precio_venta_subtotal_dolares;?></label>
                                        ...
                                        <!--
                                        <td class="text-right" >
                                            <label id="tdAdicionalDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->adicional_dolares;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdSubTotalDolares1"><?php echo $GLOBALS['oOrden_Venta_Detalle']->subtotal_dolares1;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdDescuentoDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->descuento_dolares;?></label>
                                         ...
                                         <td class="text-right" >
                                            <label id="tdValorVentaDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->valor_venta_dolares;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdIscDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->visc_dolares;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdIgvDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->vigv_dolares;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdTotalDolares"><?php echo $GLOBALS['oOrden_Venta_Detalle']->precio_venta_dolares;?></label>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdSubTotalSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->precio_venta_subtotal_soles;?></label>
                                         ...
                                         <!--
                                        <td class="text-right" >
                                            <label id="tdAdicionalSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->adicional_solares;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdSubTotalSoles1"><?php echo $GLOBALS['oOrden_Venta_Detalle']->subtotal_soles1;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdDescuentoSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->descuento_soles;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdValorVentaSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->valor_venta_soles;?></label>
                                            <input type="hidden" id="txtValorVentaSoles" name="txtValorVentaSoles" class="form-control moneda" value="<?php echo $GLOBALS['oOrden_Venta_Detalle']->valor_venta_soles;?>" >
                                        </td>
                                        <td class="text-right" >
                                            <label id="tdIscSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->visc_soles;?></label>
                                             <input type="hidden" id="txtIscSoles" name="txtIscSoles" class="form-control moneda"  value="<?php echo $GLOBALS['oOrden_Venta_Detalle']->visc_soles;?>" >
                                        </td>
                                        <td class="text-right" >
                                            <label id="tdIgvSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->vigv_soles;?></label>
                                        ...
                                        <td class="text-right" >
                                            <label id="tdTotalSoles"><?php echo $GLOBALS['oOrden_Venta_Detalle']->precio_venta_soles;?></label>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        <?php if($GLOBALS['oOrden_Venta_Detalle']->isc_activo>0){?>
                 $("#selTipoISC").prop("disabled",false);
...
function calcularTipoCambio(tipo){
   ...
   function ProductoValores(){
       ...
       // var isc_valor_calculo=parseFloat(($.trim($("#txtIscValor_Calculo").val())=="")?0:$("#txtIscValor_Calculo").val());
        ...
        //valor2=redondear(valor2,bd_largo_decimal);
        ...
        if(moneda_ID==1){
            $("#valor_unitario").val(redondear(valor2,bd_largo_decimal));
        }else{
            $("#valor_unitario").val(redondear(valor3,bd_largo_decimal));
        }    
