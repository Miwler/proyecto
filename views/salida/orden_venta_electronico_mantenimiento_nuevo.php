...
?>	
<?php function fncTitle(){?> Registrar Nueva Venta<?php } ?>
...
<?php function fncTitleHead(){ ?><i class="fa fa-list-alt"></i> Registrar Venta<?php } ?>
...
<form id="form" method="POST" action="/Salida/Orden_Venta_Electronico_Mantenimiento_Nuevo" onsubmit="return validar();" class="form-horizontal">
    <input type="hidden" id="txtCadena_Numero_Cuenta" name="txtCadena_Numero_Cuenta" value="<?php echo $GLOBALS['oOrden_Venta']->cadena_numero_cuenta;?>">
    <div class="panel panel-tab rounded shadow">
        ...
        <div class="panel-body no-padding rounded-bottom form-horizontal form-bordered">
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">Razón Social:<span class="asterisk">*</span> </label>
                ...
                <div id="divDatos_Generales" class="tab-pane fade inner-all">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <textarea id="txtObservacion" name="txtObservacion" class="comentario form-control" rows="1" cols="10" maxlength="150" style="height: 70px;resize:none;overflow:auto;"><?php echo $GLOBALS['oOrden_Venta']->observacion; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
   ...
   */
    ...
    var validar=function(){
       ...
       var i=0;
        ...
        var gravadas=parseFloat($.trim($('#tdGravada').html()).split(',').join(''));
        var inafectas=parseFloat($.trim($('#tdInafecta').html()).split(',').join(''));
        var exoneradas=parseFloat($.trim($('#tdExonerada').html()).split(',').join(''));
        var vigv=parseFloat($.trim($('#tdIgv').html()).split(',').join(''));
        var importe_total=parseFloat($.trim($('#tdTotal').html()).split(',').join(''));
        if(moneda_ID==1){
    ...
    var mostrarBotones=function(){
        $("#liproductos").css("display","");
        $("#liobsequios").css("display","");
        $("#licomprobantes").css("display","");
        $("#liguias").css("display","");
    ...
    var ocultarBotones=function(){
        $("#GenerarComprobante").css("display","none");
        $("#GenerarGuia").css("display","none");
