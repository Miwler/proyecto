...
<?php function fncTituloCabecera(){?>
     <i class="fa fa-file-text-o" aria-hidden="true"></i> Registro de Guías de Remisión
...
<form id="frm1"  method="post" action="/Salida/ajaxGuia_Remision_Mantenimiento" class="form-horizontal">
...
<script type="text/javascript">
    ...
    var fncNuevo=function(){
         window_open_view('Salida/Guia_Venta_Mantenimiento_Nuevo',0,null,fngetData);
        //window_float_open_modal('NUEVA COTIZACIÓN','Salida/Cotizacion_Mantenimiento_Nuevo','','',f,800,530);
      
    }
   
    var fncEditar=function(id){	
         window_open_view('Salida/Guia_Venta_Mantenimiento_Editar',id,null,fngetData);
