...
<?php function fncTituloCabecera(){?>
     ...
     <div class="pull-right">
         <a onclick="fngetData();" class="btn btn-success btn-add-skills">Actualizar &nbsp;<i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
    ...
    function fngetData() {
        ...
        block_ui(function(){
            enviarAjax('Salida/ajaxOrden_Venta_Electronico_Mantenimiento', 'frm1', myObject, function (res) {
    ...
    var fncNuevo=function(){
        window_open_view('Salida/Orden_Venta_Electronico_Mantenimiento_Nuevo','',null,fngetData);
        //window_float_open_modal('REGISTRAR NUEVA ORDEN DE VENTA','Salida/Orden_Venta_Electronico_Mantenimiento_Nuevo','','',f,800,480);
    }
