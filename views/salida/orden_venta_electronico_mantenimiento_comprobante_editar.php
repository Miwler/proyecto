...
<form id="frm1"  method="post"  action="Salida/Orden_Venta_Electronico_Mantenimiento_Comprobante_Editar/<?php echo $GLOBALS['oFactura_Venta']->ID;?>" onsubmit="return validar();" class="form-horizontal">
            ...
            <div class="tab-content">
                <div id="divDatos_Generales" class="tab-pane fade in active inner-all">
                    ...
                    <div class="form-group">
                        ...
                        <!--
                        <label class="control-label col-sm-3">Tipo impuesto:</label>
                        <div class="col-lg-3 col-md-3 col-sm-3">
                ...
                <div id="divProductos" class="tab-pane fade inner-all">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="ckbox ckbox-theme">
                                <input type="checkbox" id="ckver_adicional" name="ckver_adicional" value="1" <?php  echo(($GLOBALS['oFactura_Venta']->ver_adicional==1)?" checked ":"")?> onclick="cargar_detalle_factura();">
                        ...
                        <div class="col-sm-2">
                            <div class="ckbox ckbox-theme">
                                <input type="checkbox" id="ckincluir_obsequios" name="ckincluir_obsequios"  value="1" <?php  echo(($GLOBALS['oFactura_Venta']->incluir_obsequios==1)?" checked ":"")?> onclick="cargar_detalle_factura();">
                ...
                <div id="divCosto" class="tab-pane fade inner-all">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control decimal" id="txtPorcentaje_Descuento" autocomplete="off" name="txtPorcentaje_Descuento" onkeyup="fncCalcularDescuento();" disabled value="<?php echo $GLOBALS['oFactura_Venta']->porcentaje_descuento;?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control decimal"  id="txtOtros_Cargos" autocomplete="off" name="txtOtros_Cargos" onkeyup="fncSuma_Otros_Cargos();" disabled value="<?php echo $GLOBALS['oFactura_Venta']->otros_cargos;?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">Descuento</label>
 ...
 <script type="text/javascript">
    ...
    var fncSelComprobante=function(tipo_comprobante_ID){
        
        cargarValores1('/Salida/ajaxExtraerSeries',tipo_comprobante_ID,1,function(resultado){
    ...
    $(document).ready(function(){
        <?php if($GLOBALS['oFactura_Venta']->estado_ID==93||$GLOBALS['oFactura_Venta']->estado_ID==94){?>
                bloquear_edicion();
        <?php }?>
    ...
    var bloquear_edicion=function(){
        ...
        $("#btnRegresar").html('<span class="glyphicon glyphicon-ban-circle"></span> Cerrar');
    }
    
    $("#ckCon_Guia").click(function(){
        var valor=$("#ckCon_Guia").is(":checked")? 1:0;
        var factura_ID=$("#txtID").val();
        
        cargarValores1('Salida/AjaxMarcarConGuia',factura_ID,valor,function(resultado){
            if(resultado.resultado=="-1"){
                if(valor==0){
                    $("#ckCon_Guia").prop('checked',false);
                }else{
                    $("#ckCon_Guia").prop('checked',true);
                }
                mensaje.error("Ocurrió un error", resultado.mensaje);
            }
            if(resultado.resultado>0){
                mensaje.success("Resultado",resultado.mensaje);
