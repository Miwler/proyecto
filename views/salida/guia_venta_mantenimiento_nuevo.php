...
<form id="frm1" method="post" role="form" action="Salida/Guia_Venta_Mantenimiento_Nuevo" onsubmit="return validar();" class="form-horizontal">
                ...
                <div id="divDatos_Generales" class="tab-pane fade in active inner-all">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                         ...
                         <label class="control-label col-lg-3 col-md-3 col-sm-3" style="display: none;">N° orden de venta:<span class="asterisk">*</span></label>
