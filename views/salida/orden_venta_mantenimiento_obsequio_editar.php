...
<form id="frm1"  method="post"  action="Ventas/Orden_Venta_Mantenimiento_Obsequio_Editar/<?php echo $GLOBALS['oOrden_Venta_Detalle']->ID;?>" onsubmit="return validar();" class="form-horizontal">
