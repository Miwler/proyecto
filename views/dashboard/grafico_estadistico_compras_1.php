      ...
      <script type="text/javascript">
        $(function () {
            $('#container_DiarioSoles').highcharts({
                ...
                title: {
                    text: 'Compras Dia de la Semana'
                },
                

                subtitle: {
                    text: 'Compras diarias de la semana'
                },
                xAxis: {
                    categories: [
                ...
                series: [
                    ...
                    <?php 
                          ...
                          foreach($GLOBALS['dtGrafico_Estadistico_Compras_DiarioSoles'] as $row){
                    ?>{
            ...
            $('#container_DiarioDolares').highcharts({
                ...
                series: [
                    ...
                    <?php 
                          ...
                          foreach($GLOBALS['dtGrafico_Estadistico_Compras_DiarioDolares'] as $row){
                    ?>{
            ...
            $('#container_DiarioxMesSoles').highcharts({
                ...
                series: [
                    ...
                    <?php 
                          ...
                          foreach($GLOBALS['dtGrafico_Estadistico_Compras_DiarioxMesSoles'] as $row){
                    ?>{
            ...
            $('#container_DiarioxMesDolares').highcharts({
                ...
                series: [
                    ...
                    <?php 
                          ...
                          foreach($GLOBALS['dtGrafico_Estadistico_Compras_DiarioxMesDolares'] as $row){
                    ?>{
            ...
            $('#container_MensualSoles').highcharts({
                ...
                series: [
                    ...
                    <?php 
                           ...
                           foreach($GLOBALS['dtGrafico_Estadistico_Compras_MensualSoles'] as $row){
                    ?>{
            ...
            $('#container_MensualDolares').highcharts({
                ...
                series: [
                    ...
                    <?php 
                           ...
                           foreach($GLOBALS['dtGrafico_Estadistico_Compras_MensualDolares'] as $row){
                    ?>{
            ...
            $('#container_AnualSoles').highcharts({
                ...
                series: [
                    ...
                    <?php 
                           ...
                           foreach($GLOBALS['dtGrafico_Estadistico_Compras_AnualSoles'] as $row){
                    ?>{
            ...
            $('#container_AnualDolares').highcharts({
                ...
                series: [
                    ...
                    <?php 
                           ...
                           foreach($GLOBALS['dtGrafico_Estadistico_Compras_AnualDolares'] as $row){
                    ?>{
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu"  style="background-color: #008CBA;">
                                        <li><a onclick="mostrar_DiarioSoles()"      style="background-color: #008CBA; color: white;font-size: 14px;">Compras Ultima Semana</a></li>
                                        <li><a onclick="mostrar_DiarioxMesSoles()"  style="background-color: #008CBA; color: white;font-size: 14px;">Compras Último Mes</a></li>
                                        <li><a onclick="mostrar_MensualSoles()"      style="background-color: #008CBA; color: white;font-size: 14px;">Compras Últimos Meses</a></li>
                                        <li><a onclick="mostrar_AnualSoles()"    style="background-color: #008CBA; color: white;font-size: 14px;">Compras Último Anio</a></li>
<!--                                        <li class="divider"></li>-->
                                    </ul>
                                </div>
                            </div>
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu"  style="background-color: #4CAF50;">
                                        <li><a onclick="mostrar_DiarioDolares()"     style="background-color: #4CAF50; color: white;font-size: 14px;">Compras Ultima Semana</a></li>
                                        <li><a onclick="mostrar_DiarioxMesDolares()" style="background-color: #4CAF50; color: white;font-size: 14px;">Compras Último Mes</a></li>
                                        <li><a onclick="mostrar_MensualDolares()"     style="background-color: #4CAF50; color: white;font-size: 14px;">Compras Últimos Meses</a></li>
                                        <li><a onclick="mostrar_AnualDolares()"   style="background-color: #4CAF50; color: white;font-size: 14px;">Compras Último Año</a></li>
<!--                                        <li class="divider" ></li>-->
                                    </ul>
                                </div>
                            </div>
