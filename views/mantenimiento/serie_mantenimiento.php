...
<?php function fncTituloCabecera(){?>
        <i class="fa fa-file-text-o" aria-hidden="true"></i> Registro de serie
<?php } ?>
<?php function fncPage(){?>
 <form id="frm1" name="frm1" method="post" action="Mantenimiento/ajaxSerie_Mantenimiento" class="form-horizontal">
                ...
                <div class="tab-pane fade in active" id="vista_buscar">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                             <input  type="text" id="txtBuscar" name="txtBuscar" class="form-control" autocomplete="off" placeholder="Ingresar serie.">
                        </div>
                    </div>
