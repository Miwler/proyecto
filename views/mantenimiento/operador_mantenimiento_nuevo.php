...
<form id="form" method="POST"  action="/Mantenimiento/Operador_Mantenimiento_Nuevo" onsubmit="return validar();" class="form-horizontal">
    <div class="form-body">
...
<script type="text/javascript">
    ...
    var validar=function(){
        ...
        if(persona_ID==""){
            mensaje.advertencia("MENSAJE DE ADVERTENCIA","Debe seleccionar una persona.","listaPersonas");
            return false;
        }
        if(comision==""){
            mensaje.advertencia("MENSAJE DE ADVERTENCIA","Debe registrar una comisión.","txtComision");
            return false;
        }
    }
