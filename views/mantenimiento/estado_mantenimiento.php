...
<?php function fncTituloCabecera(){?>
        <i class="fa fa-envelope" aria-hidden="true"></i> Mantenimiento de Estado
<?php } ?>
<?php function fncPage(){?>

<form id="frm1" name="frm1" method="post" action="/Mantenimiento/ajaxEstado_Mantenimiento" class="form-horizontal">
	...
	<script type="text/javascript">
		...
		var fncNuevo=function(){			
			window_float_open('/Mantenimiento/Estado_mantenimiento_Nuevo','','',f);
		}
		
		var fncEditar=function(id){			
			window_float_open('/Mantenimiento/Estado_mantenimiento_Editar',id,'',f);
		}
		
		var fncEliminar=function(id){			
			gridEliminar(f,id,'/Mantenimiento/ajaxEstado_mantenimiento_Eliminar');
		}
