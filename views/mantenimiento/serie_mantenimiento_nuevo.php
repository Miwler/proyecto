...
function fncTitle() { ?>Nueva Serie<?php } ?>
...
function fncTitleHead() { ?>Nueva Serie<?php } ?>
...
function fncPage() { ?>
    <?php if (!isset($GLOBALS['resultado']) || $GLOBALS['resultado'] == -1) { ?>
        <form id="form" method="POST" style="width:300px; height: 300px;" action="/Mantenimiento/Serie_Mantenimiento_Nuevo" onsubmit="return validar();">
...
<!--                            <option value="0">SELECCIONAR</option>-->
                         ...
                         <script type="text/javascript">
                              $('#cboComprobante_Tipo').val(<?php echo $GLOBALS['oSerie']->comprobante_tipo_ID;?>);
                         </script>
