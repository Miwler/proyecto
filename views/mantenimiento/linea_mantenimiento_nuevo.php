...
function fncTitle() { ?>Nueva Línea<?php } ?>
...
function fncTitleHead() { ?><i class="fa fa-align-left" aria-hidden="true"></i>Nueva Línea<?php } ?>
...
<form id="form" method="POST"  action="/Mantenimiento/Linea_Mantenimiento_Nuevo" style="width: 600px;padding-top:10px;" enctype="multipart/form-data" onsubmit="return validar();">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <lable>Nombre: </lable>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" style="margin-bottom: 15px;">
