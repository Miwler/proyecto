...
<h1 class="title-principal">
		Mantenimiento de Representante Proveedor
	</h1>
        <form id="frm1" name="frm1" method="post" action="/Mantenimiento/ajaxRepresentanteProveedor_Mantenimiento">
		<div class="tool">
	...
	<script type="text/javascript">
		...
		var fncNuevo=function(){			
			window_float_open('/Mantenimiento/RepresentanteProveedor_mantenimiento_Nuevo','','',f);
		}
		
		var fncEditar=function(id){			
			window_float_open('/Mantenimiento/RepresentanteProveedor_mantenimiento_Editar',id,'',f);
		}
		
		var fncEliminar=function(id){			
			gridEliminar(f,id,'/Mantenimiento/ajaxRepresentanteProveedor_mantenimiento_Eliminar');
		}
