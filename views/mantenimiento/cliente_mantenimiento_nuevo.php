...
<form id="form1" method="POST" action="/Mantenimiento/Cliente_Mantenimiento_Nuevo" style="width:920px; height: 550px;" onsubmit="return validar();">
             ...
             <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <input type="text" id="txtDireccion1" name="txtDireccion1" autocomplete="off" class="form-control text-uppercase">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
