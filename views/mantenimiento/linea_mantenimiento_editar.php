...
<form id="form" method="POST"  action="/Mantenimiento/Linea_Mantenimiento_Editar/<?php echo $GLOBALS['oLinea']->ID; ?>" style="width: 600px;padding-top:10px;" enctype="multipart/form-data" onsubmit="return validar();">
        <div class="row">
