...
<?php function fncTituloCabecera(){?>
        <i class="fa fa-users" aria-hidden="true"></i> Registros de clientes
...
<form id="frm1"  method="post" action="/Mantenimiento/ajaxCliente_Mantenimiento" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                     <input  type="text" id="txtRazon_Social" name="txtRazon_Social" class="form-control" autocomplete="off" placeholder="Ingresar la razon social.">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
        ...
        var fncEliminar=function(id){			
                gridEliminar(f,id,'/Mantenimiento/ajaxCliente_mantenimiento_Eliminar');
        }
