...
function fncTitleHead() { ?><i class="fa fa-address-card-o" aria-hidden="true"></i> Editar Numero de Cuenta<?php } ?>
...
<?php if (!isset($GLOBALS['resultado']) || $GLOBALS['resultado'] == -1) { ?>
    <form id="form"  method="POST" action="/Mantenimiento/Numero_Cuenta_Mantenimiento_Editar/<?php echo $GLOBALS['oNumero_Cuenta']->ID;?>" style="width:500px;padding-top:15px;" onsubmit="return validar();" >
        <div class="row">
...
<script type="text/javascript">
    var validar=function(){
        ...
        if(nombre_banco==""){
            mensaje.error("Mensaje de error","Debe registrar el nombre de banco.",'txtNombre_Banco');
            return false;
        }
        if(numero==""){
