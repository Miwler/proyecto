...
?>	
<?php function fncTitle() { ?>Nuevo Representante cliente<?php } ?>
...
<?php function fncTitleHead() { ?>Contacto Cliente<?php } ?>
...
<form id="form" style="width:620px; height: 320px;" method="POST" action="/Mantenimiento/RepresentanteCliente_Mantenimiento_Nuevo" onsubmit="return validar();">
...
<script>
	...
	if(cliente==0){
            $('#divMensaje').html('Selecione un cliente');
            $('#cboCliente').focus();
            return false;
        }	
		if (dni.length != 8) {
