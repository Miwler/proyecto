...
<h1 class="title-principal">
	...
	<script type="text/javascript">
		...
		var fncNuevo=function(){			
			window_float_open('/Mantenimiento/RepresentanteCliente_mantenimiento_Nuevo','','',f);
		}
		...
		var fncEliminar=function(id){			
			gridEliminar(f,id,'/Mantenimiento/ajaxRepresentanteCliente_mantenimiento_Eliminar');
		}
