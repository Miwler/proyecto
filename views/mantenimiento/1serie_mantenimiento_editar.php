...
function fncTitle() { ?>Editar Serie<?php } ?>
...
function fncTitleHead() { ?><i class="fa fa-taxi" aria-hidden="true"></i> Editar Serie<?php } ?>
...
<form id="form" method="POST"  action="/Mantenimiento/Serie_Mantenimiento_Editar/<?php echo $GLOBALS['oSerie']->ID; ?>" onsubmit="return validar();" >
