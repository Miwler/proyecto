...
<div class="container">
    <form id="form" method="POST" style="width: 600px;"  action="/Mantenimiento/Producto_Mantenimiento_Editar/<?php echo $GLOBALS['oProducto']->ID; ?>" enctype="multipart/form-data"  onsubmit="return validar();">
        ...
        <div class="panel panel-<?php echo $_SESSION['cabecera'];?>">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-9">
                        <textarea id="txtCaracteristicas"  name="txtCaracteristicas" class="form-control text-uppercase"><?php echo FormatTextView(strtolower($GLOBALS['oProducto']->caracteristicas));?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3">
                    ...
                    <div  class="col-md-9 col-sm-9 col-lg-9 col-xs-9">
                        <textarea id="txtEspecificaciones"  name="txtEspecificaciones" class="form-control text-uppercase"><?php echo FormatTextView(strtolower($GLOBALS['oProducto']->especificaciones));?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                ...
                <button  title="Cancelar" id="btnCancelar" name="btnCancelar" class="btn btn-danger" type="button" onclick="window_float_close();" >
