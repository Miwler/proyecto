...
function fncTitle() { ?>Nuevo Vehiculo<?php } ?>
...
function fncTitleHead() { ?><i class="fa fa-taxi" aria-hidden="true"></i> Nuevo Vehiculo<?php } ?>
...
<form id="form" method="POST"  action="/Mantenimiento/Vehiculo_Mantenimiento_Nuevo" onsubmit="return validar();" >
