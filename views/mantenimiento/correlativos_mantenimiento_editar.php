...
function fncTitle() { ?>Editar Correlativos<?php } ?>
...
function fncTitleHead() { ?><i class="fa fa-address-card-o" aria-hidden="true"></i> Editar Correlativo<?php } ?>
...
<?php if (!isset($GLOBALS['resultado']) || $GLOBALS['resultado'] == -1) { ?>
    <form id="form"  method="POST" action="/Mantenimiento/Correlativos_Mantenimiento_Editar/<?php echo $GLOBALS['oCorrelativos']->ID;?>" onsubmit="return validar();" class="form-horizontal" >
        <div class="form-body">
