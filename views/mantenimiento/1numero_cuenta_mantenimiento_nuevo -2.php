...
function fncTitle() { ?>Nuevo de cuenta<?php } ?>
...
function fncTitleHead() { ?>Nuevo numero de cuenta<?php } ?>
...
<?php if (!isset($GLOBALS['resultado']) || $GLOBALS['resultado'] == -1) { ?>
    <form id="form" method="POST" action="/Mantenimiento/Numero_Cuenta_Mantenimiento_Nuevo" style="width:580px;" onsubmit="return validar();">
        <table style="width:580px; height:200px; ">
            <tr>
                ...
                <th>Banco:</th>
                <td>
                    <input type="text" id="txtNombre_Banco" autocomplete="off" name="txtNombre_Banco">
                </td>
            </tr>
            <tr>
                <th>Numero Cuenta:</th>
                <td>
                    <input type="text" id="txtNumero" class="text-int" autocomplete="off" name="txtNumero">
                </td>
            </tr>
            <tr>
                <th>N&uacute;mero Cuenta Interbancaria:</th>
                <td>
                    <input type="text" id="txtCci" class="text-int" autocomplete="off" name="txtCci">
                </td>
            </tr>
            <tr>
                <th>Moneda</th>
