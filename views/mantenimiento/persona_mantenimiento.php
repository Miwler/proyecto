...
<form id="frm1"  method="post" action="/Mantenimiento/ajaxPersona_Mantenimiento" class="form-horizontal">
...
<script type="text/javascript">
        ...
        var fncNuevo=function(){
            window_float_open_modal('REGISTRAR NUEVO PERSONA','/Mantenimiento/Persona_Mantenimiento_Nuevo','','',f,800,500);
        }

        var fncEditar=function(id){
            window_float_open_modal('EDITAR PERSONA','/Mantenimiento/Persona_Mantenimiento_Editar',id,'',f,800,500);   
        }
