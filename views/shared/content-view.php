...
<head>
	...
	<script type="text/javascript" >
        ...
        var fparentPadre1= parent.fparentPadre1;   
        function redireccion(ruta){
            console.log(ruta);
            parent.redireccion(ruta);
...
<body>
    <div class="header-content">
        <h2 id="h2Titulo"><?php fncTitleHead();?></h2>
        <div id="divArbol" class="breadcrumb-wrapper hidden-xs">
     ...
     <!-- /.header-content -->
    <div id="main" class="body-content animated fadeIn">
        <!--<div id ="divHeader">			
    ...
    <script type="text/javascript">
       ...
       $(document).ready(function(){
           ...
           var ul=parent.get_breadcrumb();
           var titulo=$("#h2Titulo").text();
           $("#divArbol").html(ul+'<li class="active">'+titulo+'</li></ol>');
