...
?>	
<?php function fncTitle(){?>Detalle Orden compra<?php } ?>

<?php function fncHead(){?>
<script type="text/javascript" src="include/js/jForm.js"></script>
<?php } ?>

<?php function fncTitleHead(){?>Editar detalle de compra<?php } ?>
...
<form id="frm1" name="frm1" method="post" action="/Ingreso/orden_compra_mantenimiento_editar_producto/<?php echo $GLOBALS['oOrden_Compra_detalle']->ID; ?>" onsubmit="return validar();" class="form-horizontal">
    <div class="form-body">
        ...
        <div class="row" style="margin:10px 0">
            ...
            <script type="text/javascript">
               $("#selProducto").val(<?php echo $GLOBALS['oOrden_Compra_detalle']->producto_ID;?>);
            </script>
        </div>
        <div class="form-group">
 ...
 <script type="text/javascript">
    ...
    var fncCerrar=function(){
        ...
        //window.parent.fncCloseFloat('form',fParent);
    }
