...
<form id="frm1" name="frm1" method="POST" action="/Ingreso/Anulacion_Comprobante_Mantenimiento_Registro/<?php echo $GLOBALS['oCompra']->ID;?>" onsubmit="return validar();">
    <div class="panel panel-info form-horizontal">
        <div class="panel-body form-body">
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Serie:</label>
            ...
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Número:</label>
            ...
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Fecha emisión:</label>
                ...
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Fecha vencimiento:</label>
                <div class="col-lg-3 col-md-3 col-sm-3">
            ...
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Sub Total:</label>
                <div class="col-lg-3 col-md-3 col-sm-3">
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 col-md-3 col-sm-3 control-label">Saldo pendiente:</label>
                <div class="col-lg-3 col-md-3 col-sm-3">
          ...
          <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-lg-3 col-md-3 col-sm-3 control-label">Fecha:</label>
                        <div class="col-lg-3 col-md-3 col-sm-3">
                        ...
                        <label class="col-lg-3 col-md-3 col-sm-3 control-label">Motivo:</label>
                        <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <select id="seloperador_ID_anulacion" name="seloperador_ID_anulacion" class="form-control">
                                ...
                                <option value="<?php echo $item['ID']?>"><?php echo utf8_encode($item['apellido_paterno'].' '.$item['apellido_materno'].','.$item['nombres'])?></option>
