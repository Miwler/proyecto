...
function fncTitle() { ?>Nuevo Datos Generales<?php } ?>
...
function fncTitleHead() { ?>Nuevo Datos Generales<?php } ?>
...
function fncPage() { ?>
    <?php if (!isset($GLOBALS['resultado']) || $GLOBALS['resultado'] == -1) { ?>
        <form id="form" method="POST" action="/Mantenimiento/Datos_generales_Mantenimiento_Nuevo" onsubmit="return validar();">

            <div class="col-lg-12" style="margin-top:10px">
			
       <table width="870" height="430"  cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="250"> <input id="txtMail_Info" name="txtMail_Info" type="email"   autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->mail_info; ?>"/><samp style="color: red;">*</samp></td>
  </tr>
  <tr>
    <td><label>Razon Social:</label></td>
    <td><input id="txtRazon_Social" name="txtRazon_Social" type="text" autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->razon_social; ?>"/><samp style="color: red;">*</samp></td>
    <td><label>Mail_Venta:</label></td>
    <td> <input id="txtMail_Venta" name="txtMail_Venta" type="email"  autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->mail_venta; ?>"/><samp style="color: red;">*</samp></td>
  </tr>
  <tr>
    <td><label>Alias:</label></td>
    <td><input id="txtAlias" name="txtAlias" type="text"autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->alias; ?>"/><samp style="color: red;">*</samp></td>
  ...
  <tr>
    ...
    <td><input id="txtDireccion" name="txtDireccion" type="text" autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->direccion; ?>"/><samp style="color: red;">*</samp></td>
  ...
  <tr>
    ...
    <td><input id="txtDireccion_Fiscal" name="txtDireccion_Fiscal" type="text" autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->direccion_fiscal; ?>"/><samp style="color: red;">*</samp></td>
  ...
  <tr>
    ...
    <td><input id="txtMail_Principal" name="txtMail_Principal" type="email"   autocomplete="off" value="<?php echo $GLOBALS['oDatos_generales']->mail_principal; ?>" /><samp style="color: red;">*</samp></td>
  ...
  <tr>
      <td>Observación</td>
      <td colspan="3">
         <input id="txtObservacion" name="txtObservacion" type="text" autocomplete="off" style="width:640px;" value="<?php echo $GLOBALS['oDatos_generales']->observacion; ?>" /> 
      </td>
  </tr>
</table>
