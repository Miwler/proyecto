...
<form id="frm1"  method="post"  action="Ventas/Orden_Venta_Mantenimiento_Obsequio_Nuevo/<?php echo $GLOBALS['oOrden_Venta']->ID;?>" onsubmit="return validar();" class="form-horizontal">
