...
<form id="frm1" name="frm1" method="post"  action="Ventas/Orden_Venta_Mantenimiento_Registro_Componente_Nuevo/<?php echo $GLOBALS['oOrden_Venta_Detalle']->orden_venta_detalle_padre_ID;?>" onsubmit="return validar();" class="form-horizontal">
