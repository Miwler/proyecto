...
<form id="frm1"  method="post" action="Ventas/Cotizacion_Mantenimiento_Obsequio_Editar/<?php echo $GLOBALS['oCotizacion_Detalle']->ID;?>" onsubmit="return validar();" class="form-horizontal">
