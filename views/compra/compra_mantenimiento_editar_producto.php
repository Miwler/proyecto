...
<form id="frm1"  method="post" action="Compra/compra_mantenimiento_editar_producto/<?php echo $GLOBALS['oCompra_Detalle']->ID; ?>" onsubmit="return validar();" class="form-horizontal">
