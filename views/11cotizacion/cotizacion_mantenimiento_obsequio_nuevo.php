...
<form id="frm1"  method="post" style='width: 1100px; height: auto;' action="Cotizacion/Cotizacion_Mantenimiento_Obsequio_Nuevo/<?php echo $GLOBALS['oCotizacion']->ID;?>" onsubmit="return validar();">
