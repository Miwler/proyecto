...
<form id="frm1" name="frm1" method="post" style='width: 1100px; height: 500px;' action="Cotizacion/Cotizacion_Mantenimiento_Registro_Adicional_Editar/<?php echo $GLOBALS['oCotizacion_Detalle']->ID;?>" onsubmit="return validar();">
    ...
    <table width='1000px' height='300px' style='margin:5px auto;'>
            ...
            <td id="tdProducto" class="lista_producto" colspan="4">
                ...
                <script type="text/javascript">
                    <?php if($GLOBALS['oCotizacion_Detalle']->ID>0){ ?>
                         cargarLista('divProductos', 'txtProducto_ID', '/Compra/ajaxListar_Producto', 350,<?php echo $GLOBALS['oCotizacion_Detalle']->oProducto->ID;?>,'<?php echo sprintf("%'.05d",$GLOBALS['oCotizacion_Detalle']->oProducto->ID);?>-<?php  echo FormatTextViewHtml($GLOBALS['oCotizacion_Detalle']->oProducto->nombre);?>', true,'filtroLista',500,20);
                    <?php } else {?>
                         newLista('divProductos', 'txtProducto_ID', '/Compra/ajaxListar_Producto', 350, true,'filtroLista',500,20);
                    <?php } ?> 
        ...
        <tr>
            <th>Cantidad</th>
            <th>
                <input type="text" id="txtCantidad"  name="txtCantidad" class="obligatorio" autocomplete="off" style="width:80px;" value="<?php echo $GLOBALS['oCotizacion_Detalle']->cantidad;?>" onkeyup="ProductoValores();">
        ...
        <tr>
            ...
            <th>US$</th>
            <td>
                <input type="text" id="txtPrecioUnitarioDolares" autocomplete="off" class="moneda obligatorio"  name="txtPrecioUnitarioDolares" style="width:100px;" value="<?php echo $GLOBALS['oCotizacion_Detalle']->precio_venta_unitario_dolares;?>" onkeyup="calcularTipoCambio('2');">
            </td>
            <th>S/.</th>
            <td>
                <input type="text" id="txtPrecioUnitarioSoles" autocomplete="off" class="moneda obligatorio" name="txtPrecioUnitarioSoles" style="width:100px;" value="<?php echo $GLOBALS['oCotizacion_Detalle']->precio_venta_unitario_soles;?>" onkeyup="calcularTipoCambio('1');">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ckSeparacion" id="ckSeparacion" disabled value="1" onclick="fncTiempo_Separacion();">
                <script type='text/javascript'>
                <?php if($GLOBALS['oCotizacion_Detalle']->separaciones==1){ ?>
                    $('#ckSeparacion').prop('checked', true); 
                <?php } ?>
                <?php if($GLOBALS['oCotizacion_Detalle']->stock>0){ ?>
