...
<form id="frm1"  method="post" style='width: 1100px; height: auto;' action="Cotizacion/Cotizacion_Mantenimiento_Producto_Editar/<?php echo $GLOBALS['oCotizacion_Detalle']->ID;?>" onsubmit="return validar();">
    <table width='1000px' height='200px' style='margin:0 auto;'>
        ...
        <tr>
            <th colspan='2' style='text-align: left;'>
                ...
                <script type="text/javascript">
                    <?php if($GLOBALS['oCotizacion_Detalle']->separacion==1||$GLOBALS['oInventario']->stock>0){?>
                    $('#ckSeparacion').prop('disabled',false);
                        
                    <?php } ?>
                    <?php if($GLOBALS['oCotizacion_Detalle']->separacion==1){?>
                    $('#ckSeparacion').prop('checked',true);
                        
                    <?php } ?>
                </script>
           &nbsp;&nbsp;&nbsp;&nbsp;
            Tiempo(días) <input type="number" name="txtTiempo_Separacion" disabled id="txtTiempo_Separacion" value="<?php echo $GLOBALS['oCotizacion_Detalle']->tiempo_separacion;?>" style="width:50px;">
        ...
        <tr>
            ...
            <td style='border-bottom:1px solid #000;'>
                <input type="text" id="txtAdicionalSoles" name="txtAdicionalSoles" class="moneda" style="width:100px;" value="<?php echo $GLOBALS['oCotizacion_Detalle']->adicional_soles;?>" disabled>
