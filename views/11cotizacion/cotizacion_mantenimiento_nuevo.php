...
<form id="form" method="POST" action="/Cotizacion/Cotizacion_Mantenimiento_Nuevo" onsubmit="return validar();" style="width:1100px;height:500px; ">
    <table style='width:1000px;height: 300px; margin:5px auto'>
        ...
        <tr>
            <td colspan='2'>
                <textarea id="txtObservacion" name="txtObservacion" class="comentario" rows="1" cols="10" maxlength="150" style="width:450px;height: 80px;"><?php echo FormatTextView($GLOBALS['oCotizacion']->observacion); ?></textarea>
...
<script type="text/javascript">
    ...
    var prueba=function(){
        cargarValores('Cotizacion/ajaxPrinter',1,function(resultado){
    ...
    var validar=function(){
        ...
        if(estado_ID=="2"){
            ...
            var contador=0;
            $('#DivProductos .item-tr').each(function(){
                 
                contador++;
            });
            if(contador==0){
               toastem.error('Debes ingresar un producto para poder cambiar de estado.');
               $('#selEstado').focus();
                return false; 
            }
        }
