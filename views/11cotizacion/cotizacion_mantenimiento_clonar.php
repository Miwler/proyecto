...
<form id="form" method="POST" action="/Cotizacion/Cotizacion_Mantenimiento_Clonar/<?php echo $GLOBALS['oCotizacion']->ID;?>" onsubmit="return validar();" style="width:1100px;height:600px; ">
    <table style='width:1000px;height: 300px; margin:5px auto'>
        ...
        <tr>
            ...
            <th colspan='4' style='text-align: center;'>Número de cuenta en <label id="lbMoneda">Dólares (US$.)</label></th>
        </tr>
        <tr>
            <td colspan='2'>
