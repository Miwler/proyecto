 ...
 ?>
        ...
        <div style="margin-left: 20px;margin-right: 20px;margin-bottom: 5px;font-size: 10px;">
            <table  style="width:100%;">
                <tr style="border: 1px solid;">
                    ...
                    <td style="text-align: left;" rowspan="2"> <?php $oGuia->fecha ?> </td>
        ...
        <td style="width:350px;text-align:center;">
            <table  style="width:100%;border:1px solid;">
                ...
                <tr >
                    <td style="font-size: 10px;">NOMBRES/RAZON SOCIAL: <?php $ocliente->nombre ?> </td>
                </tr>
                <tr style="font-size: 11px;">
                    <td>R.U.C:   <?php $ocliente->ruc ?></td>
                </tr>
            ...
            <table  style="width:100%;border:1px solid;">
                ...
                <tr >
                    <td style="font-size: 11px;">VEHICULO MARCA Y PLACA NRO: <?php  $oVehiculo->placa."   ".$oVehiculo->descripcion?></td>
                </tr>
                <tr >
...
<!--       inicio quinta columna de tablas-->
 <div style="margin-right: 20px;margin-bottom: 5px;">
       ...
       <?php foreach ( $dtGv as $Detalle) {?>
      <tr>
        <td><?php $Detalle['cantidad']?></td>
        <td><?php $Detalle['descripcion']?></td>
        <td><?php $Detalle['precio_venta_unitario']?></td>
        <td><?php  $Detalle['precio_venta']?></td>
      </tr>';
      <?php  } ?>
        </table>
        </div>
