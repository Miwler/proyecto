...
function fncPage() { ?>
    ...
    <script type="text/javascript">
        ...
        var fncNuevo = function () {
            window_float_open('/Venta/Guia_Venta_Nuevo', '', '', f);
        }
        var fncGenerar = function (id) {
            window_float_open('/Cotizacion/Guia_venta_Generar', id, '', f);
        }
        var fncEditar = function (id) {
            window_float_open('/Venta/Guia_venta_Editar', id, '', f);
        }

        var fncEliminar = function (id) {
            gridEliminar(f, id, '/Venta/ajaxGuia_venta_Eliminar');
        }
