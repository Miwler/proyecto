...
<form id="frm1" name="frm1" method="post" style='width: 1100px; height: 500px;' action="Cotizacion/Cotizacion_Mantenimiento_Registro_Adicional_Nuevo/<?php echo $GLOBALS['oCotizacion_Detalle']->cotizacion_detalle_padre_ID;?>" onsubmit="return validar();">
    ...
    <table width='1000px' height='300px' style='margin:5px auto;'>
        ...
        <tr>
            ...
            <td rowspan="5" id="tdComentario" style="vertical-align: top;">
                <textarea id="txtDescripcion" name="txtDescripcion" class="comentario" rows="7"  cols="40" maxlength="3000"   style="width:490px;height:60px;"></textarea>
            </td>
        </tr>
        <tr>
            <th>Categoría</th>
