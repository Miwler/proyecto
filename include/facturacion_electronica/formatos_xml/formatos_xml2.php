    ...
    function factura_venta_UBL2_1($array){
        ...
        $this->inyectar_atributo2_1($xml,$Invoice);
            ...
            $ProfileID=$Invoice->appendChild($ProfileID);
                /*16/03/2019$schemeName=$xml->createAttribute('schemeName');
                ...
                /*16/03/2019$schemeURI=$xml->createAttribute('schemeURI');
            ...
            $InvoiceTypeCode=$xml->createElement('cbc:InvoiceTypeCode',$array['TipoDocumento']); 
            $InvoiceTypeCode =$Invoice->appendChild($InvoiceTypeCode);
                /*16/03/2019$listID=$xml->createAttribute("listID");
                $listID->value="0101";
        ...
        if(isset($array['Relacionados']) && count($array['Relacionados'])>0 && $array['Relacionados']['NroDocumento']!=""){
            ...
            /*16/06/2019$Signature=$xml->createElement('cac:Signature'); 
            $Signature=$Invoice->appendChild($Signature);
                        ...
                        //16/03/2019
                            ...
                            $AddressLine=$RegistrationAddress->appendChild($AddressLine);
                                ...
                                $Line=$AddressLine->appendChild($Line);
                                    $direccion_completa=$xml->createTextNode(substr(FormatTextViewXML($array['Emisor']['Direccion']),0,200));
                            ...
                            $CitySubdivisionName=$RegistrationAddress->appendChild($CitySubdivisionName);
                                $Urbanizacion=$xml->createTextNode(substr(FormatTextViewXML($array['Emisor']['Urbanizacion']),0,25));
                                $Urbanizacion=$CitySubdivisionName->appendChild($Urbanizacion); 
                            $ID=$xml->createElement("cbc:ID",$array['Emisor']['Ubigeo']);
                            ...
                            $CountrySubentity=$xml->createElement("cbc:CountrySubentity",substr(FormatTextViewXML($array['Emisor']['Urbanizacion']),0,30));
