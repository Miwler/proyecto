...
// convierte a minúsculas toda una cadena la función strtolower
    ...
    function insertar() {
        ...
        try {
            ...
            $ID=$cn->getData($q);
            $q = 'insert into guia_venta(ID,factura_venta_ID,serie,fecha_emision,numero_orden_compra,numero_orden_venta,';
            ...
            $q.=',"'. $this->numero_orden_compra.'","'.$this->numero_orden_venta.'",'.$this->numero.',"'.$this->numero_concatenado.'",'.$vehiculo.','.$chofer.','.$this->estado_ID;
    ...
    function actualizar() {
        ...
        try {
            ...
            $q.=',numero_concatenado="'.$this->numero_concatenado.'",fecha_emision='.$fecha_emision.',numero_orden_compra="'. $this->numero_orden_compra;
            $q.='",numero_orden_venta="'.$this->numero_orden_venta.'",vehiculo_ID='.$vehiculo.',chofer_ID='.$chofer.',estado_ID='.$this->estado_ID;
