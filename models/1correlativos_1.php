...
class correlativos1 {
    ...
    static function getGridCorrelativos($tabla,$electronico)
    {
            $cn =new connect_new();
            try 
            {
                    ...
                    $q.=' from correlativos cor,tipo_comprobante_empresa tce';
                    $q.=' where cor.tipo_comprobante_empresa_ID=tce.ID and tce.del=0 and cor.del=0 ';
                    $q.='and tce.tabla="'.$tabla.'" and  tce.empresa_ID='.$_SESSION['empresa_ID'].' and cor.electronico='.$electronico;
