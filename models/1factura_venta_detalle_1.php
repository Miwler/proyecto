...
// convierte a minúsculas toda una cadena la función strtolower
    ...
    function insertar()
    {
        ...
        try{
            ...
            $ID=$cn->getData($q);
            $q='INSERT INTO factura_venta_detalle (ID,factura_venta_ID,salida_detalle_ID,impuestos_tipo_ID,usuario_id) ';
            $q.='VALUES ('.$ID.','.$this->factura_venta_ID.','.$this->salida_detalle_ID.','.$this->impuestos_tipo_ID.','.$this->usuario_id.')';
            //echo $q;
	...
	$retornar=-1;
        try{
            ...
            $q='UPDATE factura_venta_detalle set factura_venta_ID='.$this->factura_venta_ID.',salida_detalle_ID='.$this->salida_detalle_ID.',impuestos_tipo_ID='.$this->impuestos_tipo_ID.', usuario_mod_id='.$this->usuario_mod_id;
