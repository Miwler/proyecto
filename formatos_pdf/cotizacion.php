...
class PDF1 extends FPDF
{
    ...
    function presentacion(){
        ...
        if($this->oRepresentanteCliente!=null){
            $representante=  FormatTextView($this->oRepresentanteCliente->nombres." ".$this->oRepresentanteCliente->apellido_materno." ".$this->oRepresentanteCliente->apellido_materno);
        }
   ...
   function costo_total($y){
    ...
    function otros_datos($y){
        ...
        $this->SetFont('Arial','',8);
        $this->MultiCell(80,4, FormatTextViewPDF($this->oCotizacion->lugar_entrega),0,'J');
        $this->Ln(1);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,5,'Tiempo entrega:',0,0,'L');
        $this->SetFont('Arial','',8);
        $this->Cell(50,5,$this->oCotizacion->plazo_entrega.FormatTextViewPDF(' días'),0,0,'L');
        $this->Ln(4);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,5,'Validez de la oferta:',0,0,'L');
        $this->SetFont('Arial','',8);
        $this->Cell(50,5,$this->oCotizacion->validez_oferta.FormatTextViewPDF(' días'),0,0,'L');
        $this->Ln(4);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,5,utf8_decode('Garantía:'),0,0,'L');
        $this->SetFont('Arial','',8);
        $this->Cell(50,5,FormatTextViewPDF($this->oCotizacion->garantia),0,0,'L');
        $this->Ln(4);
        $this->SetFont('Arial','B',8);
        ...
        $this->SetFont('Arial','',8);
        $this->Cell(25,5,'(511) '.$this->oEjecutivo->telefono,0,0,'L',false);
        $this->SetFont('Arial','B',8);
        $this->Cell(15,5,'Anexo:',0,0,'L',false);
        //$this->SetFont('Arial','',8);
        //$this->Cell(15,5,$this->oOperador->anexo,0,0,'L',false);
        ...
        $this->SetFont('Arial','',8);
        $this->Cell(55,5,$this->oEjecutivo->celular,0,0,'L',false);
        $this->Ln();
        $h2=$this->GetY();
        $this->SetXY(130,$h2);
        $this->SetFont('Arial','B',8);
        ...
        $this->SetFont('Arial','',8);
        $this->Cell(55,5,$this->oEjecutivo->mail,0,0,'L',false);
        $this->Ln();
        //Detalle de 
   }
   function Footer(){
